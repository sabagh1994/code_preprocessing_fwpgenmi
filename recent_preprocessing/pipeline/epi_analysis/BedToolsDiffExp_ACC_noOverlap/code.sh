...
codedir="./mycode";
orgdir="/shared-mounts/sinhas-storage1/mayo/offer_project/recent_preprocessing/pipeline/epi_analysis/BedToolsDiffExp_ACC_noOverlap"
basedir="$orgdir/DiffACC";
...
ACCdir="/shared-mounts/sinhas-storage1/mayo/offer_project/recent_preprocessing/updated_data/ATAcSeq/"
