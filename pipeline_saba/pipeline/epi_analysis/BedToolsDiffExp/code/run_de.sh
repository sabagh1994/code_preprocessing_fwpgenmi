...
mkdir -p $4
name1=`echo $1 | sed -e "s/^.*\///g" | sed -e "s/\..*$//g"`;
name2=`echo $2 | sed -e "s/^.*\///g" | sed -e "s/\..*$//g"`;
...
/home/casey/offer/analysis/BedToolsDiffExp/code/process_de.pl $4/$3.long.narrowPeak > $4/$3_intersections.narrowPeak;
...
awk '{print $1,$2,$3,$4,-1*$5,$6,-1*$7,-1*$8,-1*$9,-1*$10}' $4/$name2.exclusive.narrowPeak | tr ' ' '\t' > blah && mv blah $4/$name2.exclusive.narrowPeak;
